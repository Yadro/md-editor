...
declare module "draft-js" {
    namespace Draft {
        ...
        /**
         * ContentState {Immutable.Record}
         * Представляет собой весь контент редактора
         *
         * После применения convertToRaw получаем объект со свойствами:
         * blocks {Object[]} -
         */
        ...
        function convertToRaw(contentState: ContentState): RawData;

        interface RawData {
            blocks: Block[];
            entityMap: {
                [key: number]: EntityMap
            };
        }

        interface Block {
            data;
            entityRanges: EntityRaw[];
            inlineStyleRanges: EntityRaw[];
            key: string;
            text: string;
            type: string;
        }
